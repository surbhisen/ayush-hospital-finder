...
const Footer = () => {
  return (
    <div className='Footer bg-blue-50'id='footer'>
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2023 AYUSH HOSPITAL —
            <a href="https://github.com/surbhisen" className="text-gray-600 ml-1 hover:underline" rel="noopener noreferrer" target="_blank">@Surbhi</a>
          </p>
